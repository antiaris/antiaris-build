...
module.exports = sieve => {
    ...
    sieve.src(`**/*.{${BINARY_RESOURCE}}`).pipe(sieve.stamp(boolOptions(STRICT))).end();
    ...
    src.pipe(sieve.system(boolOptions(STRICT))).pipe(sieve.uglify(boolOptions(STRICT | SKIP))).pipe(sieve.integrity(SKIP)).pipe(sieve.stamp(boolOptions(STRICT))).end();
