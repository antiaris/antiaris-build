...
// Less
sieve.hook(`${SRC}/**/*.less`, new LessTransformer().next(new IntegrityTransformer(resourceMap).next(new StampTransformer(resourceMap))));
// SRC
sieve.hook(`${SRC}/**/*.{js,jsx}`, new BabelTransformer().next(new NoopTransformer(), new SystemTransformer(resourceMap).next(new UglifyTransformer(true).next(new IntegrityTransformer(resourceMap).next(new StampTransformer(resourceMap))))));
// NODE_MODUES
