...
// NODE_MODUES
sieve.hook(`${NODE_MODULES}/**/*.{js,jsx}`, new NoopTransformer().next(new NoopTransformer(), new BabelTransformer().next(new SystemTransformer(resourceMap).next(new StampTransformer(resourceMap)))));
